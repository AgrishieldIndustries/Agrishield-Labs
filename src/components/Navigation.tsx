...
export default function Navigation() {
  ...
  const tabs = [
    ...
    { href: "/products", label: "Testing Services", Icon: ShoppingBag, isNew: false },
    { href: "/solutions", label: "Industries", Icon: Leaf, isNew: true },
    { href: "/awards", label: "Accreditation", Icon: Award, isNew: false },
